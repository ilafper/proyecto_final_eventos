...
export default function NuevoEventoFormu() {
  ...
  const creacionEvento = (nombreEvento:string,descripcionEvento:string, plazasTotales:number, fecha:Date,horaInicio:string, horaFin:string) => {
  ...
  return (
    ...
    {/* lo mismo para la hora de inicio y fin */}
        ...
        <CustomButton
              title="Crear evento"
              onPress={() => creacionEvento(nombreEvento,descripcionEvento,plazasTotales,fecha,horaInicio,horaFin)}
